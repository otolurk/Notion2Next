...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '9ef4d2b46daf4dbf8a29a09118324660',
  THEME: process.env.NEXT_PUBLIC_THEME || 'endspace', // 当前主题；本仓库仅保留 endspace 主题
  ...
  APPEARANCE_DARK_TIME: false, // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式（仅按浏览器系统深色信号 + 手动切换）

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'OTOLURK', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Per aspera ad astra', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ototime.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'otolurk, blog', // 网站关键词 英文逗号隔开
